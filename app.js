...
//
// if (runhttps) {
//   httpserv = https.createServer(cert, app).listen(opts.port, () => {
//     console.log(`https on port ${opts.port}`);
//   });
// } else {
//   httpserv = http.createServer(app).listen(opts.port, () => {
...
/*if (runhttps) {
    httpserv = https.createServer(cert, app).listen(opts.port, function() {
        console.log('https on port ' + opts.port);
    });
} else {
